...
rssBM <- bigr.transform(bf = rssBig.work, outData = "/user/yemalingodonou/RSS/forest/rss991.mtx",
                         transformPath = "/user/yemalingodonou/RSS/forest/rss991.transform",
...
forest <- bigr.randomForest(PM_IND ~ ., trainBig, directory="/user/yemalingodonou/RSS/forest/RF")

# Compute predictions for the testing set
preds <- predict(forest, testBig, directory="/user/yemalingodonou/RSS/forest.pred")
preds$ctable
preds$accuracy
